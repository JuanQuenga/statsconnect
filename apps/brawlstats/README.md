...
pnpm convex env set BRAWL_PROFILE_REVISIT_HOURS 12
pnpm convex env set BRAWL_CRAWL_MAX_CALLS_PER_HOUR 500
pnpm convex env set BRAWL_PUBLIC_MAX_CALLS_PER_HOUR 1000
```
