  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        {rows.map((row) => (
          <a key={row.id} href={routePath(`/brawlers/${row.id}`)} className="flex items-center gap-3 rounded-xl border border-border bg-card p-3 hover:border-primary/60">
