  ...
  return (
    <div className="page-shell">
      ...
      <div className="data-surface grid gap-3 p-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Input value={search.q || ""} onChange={(event) => update({ q: event.target.value || undefined })} placeholder={t("meta.search", { group: groupLabel(grouping, t) })} className="lg:col-span-2" />
