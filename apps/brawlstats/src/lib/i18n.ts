...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  en: english,
  es: {
    home: "Inicio", players: "Jugadores", clubs: "Clubes", maps: "Mapas", brawlers: "Brawlers",
  ...
  de: {
    home: "Start", players: "Spieler", clubs: "Clubs", maps: "Karten", brawlers: "Brawler",
  ...
  fr: {
    home: "Accueil", players: "Joueurs", clubs: "Clubs", maps: "Cartes", brawlers: "Brawlers",
  ...
  pt: {
    home: "Início", players: "Jogadores", clubs: "Clubes", maps: "Mapas", brawlers: "Brawlers",
  ...
  ja: {
    home: "ホーム", players: "プレイヤー", clubs: "クラブ", maps: "マップ", brawlers: "ブロウラー",
  ...
  ko: {
    home: "홈", players: "플레이어", clubs: "클럽", maps: "맵", brawlers: "브롤러",
