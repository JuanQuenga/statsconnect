...
const messages = {
  en: {
    ...
    "error.eyebrow": "ClashCrown recovery",
    ...
    "error.home": "Return to ClashCrown",
    ...
    "meta.sourceNote": "Clash Crown calculates these statistics from observed battle logs. Supercell does not publish an aggregate meta table.",
    ...
    "guides.description": "Practical fundamentals organized by deck archetype, with direct paths into live Clash Crown stats.",
  ...
  es: {
    ...
    "error.eyebrow": "Recuperación de ClashCrown",
    ...
    "error.home": "Volver a ClashCrown",
    ...
    "meta.sourceNote": "Clash Crown calcula estas estadísticas con registros de batalla observados. Supercell no publica una tabla agregada del meta.",
    ...
    "guides.description": "Fundamentos prácticos por arquetipo, con rutas directas a las estadísticas en vivo de Clash Crown.",
