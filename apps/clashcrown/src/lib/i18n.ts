...
const messages = {
  en: {
    ...
    "error.eyebrow": "Royale Stats recovery",
    ...
    "error.home": "Return to Royale Stats",
    ...
    "clan.liveDirectory": "Official live clan directory",
    ...
    "meta.sourceNote": "Royale Stats calculates these statistics from observed battle logs. Supercell does not publish an aggregate meta table.",
    ...
    "news.official": "Official Supercell source",
    ...
    "guides.description": "Practical fundamentals organized by deck archetype, with direct paths into live Royale Stats data.",
    "guides.editorial": "Editorial strategy, not a live-stat claim",
  ...
  es: {
    ...
    "error.eyebrow": "Recuperación de Royale Stats",
    ...
    "error.home": "Volver a Royale Stats",
    ...
    "clan.liveDirectory": "Directorio oficial de clanes en vivo",
    ...
    "meta.sourceNote": "Royale Stats calcula estas estadísticas con registros de batalla observados. Supercell no publica una tabla agregada del meta.",
    ...
    "news.official": "Fuente oficial de Supercell",
    ...
    "guides.description": "Fundamentos prácticos por arquetipo, con rutas directas a los datos en vivo de Royale Stats.",
    "guides.editorial": "Estrategia editorial, no una afirmación basada en datos en vivo",
